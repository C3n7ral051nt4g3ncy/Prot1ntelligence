...
- Les empreintes numériques laissés par les utilisateurs ProtonMail sur le Clear Web et sur le Dark Net.
<br>
...
Si vous souhaitez regarder la vidéo YouTube, assurez vous d'être sur un **PC** sinon ce sera pas beau de votre téléphone, mettre aussi les **paramètres de la vidéo sur 4K**.
...
# Les Modules de Protintelligence
...
Catch-all= Exemple: Je possède le nom de domaine "protintelligence.fr", si j'active le catch-all, si une personne m'envoi un mail 
en mettant n'importe quels caractères avant le "@protintelligence.fr", le mail arrivera quand même.
Exemple: La personne m'envoi un mail en mettant cette adresse: "ajzhehdo337@protintelligence.fr", mail qui n'existe pas!
Mais avec le cactch-all, il arrivera dans ma boite: "contact@protintelligence.fr"
```
### BRAVO 📡
``` 
...
Vous pourrez aussi télécharger la clé PGP de l'utilisateur et l'ajouter à votre KeyChain pour envoyer un mail chiffré à la cible/personne.
```  
### ECHO 💻
``` 
...
Vous pouvez cliquer sur le badge KO-FI en haut de ce fichier ou cliquer sur le badge BITCOIN pour envoyer un don en crypto.

 # Sans oubli de mention 📢
My Bad pour l'oubli de la mention pendant quelques heures après le début de la mise en ligne de ce script, et merci à la communauté de m'avoir aidé. 
Le code n'est pas 100% à l'identique, mais pour mon premier script/projet Python, j'ai pris des idées et certains morceaux/fork de **PROTOSINT** de **@Pixelbubble**. Protosint ne fonctionne plus pour certains modules et j'y ai ajouté mes propres modules qui me conviennent et je vais continuer à rajouter d'autres modules. Tous les projets sur GitHub en mode public sont en open source, le code aussi est en open source et publiquement accessible. Tout comme Protosint, Prot1ntelligence est sous licence MIT, libre à vous de forker et d'améliorer selon vos souhaits et besoins.
